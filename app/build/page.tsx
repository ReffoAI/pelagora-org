    ...
    <main>
      ...
      <section className="detail sand">
        <div className="container-narrow">
          ...
          <div className="section-title">It&apos;s just an API</div>
          <p style={{ fontSize: 16, lineHeight: 1.7, color: "var(--slate)", marginBottom: 32, maxWidth: 600 }}>
            Every Beacon exposes a simple REST API. Scaffold one, hit the endpoints, and your listing
            is live on the mesh in seconds. No SDK required — just HTTP. That also means your AI agent
            can drive the whole thing via the MCP server without you touching the terminal at all.
          </p>
          <div className="terminal">
            ...
            <div className="terminal-body">
              <div className="terminal-line"><span className="comment"># Scaffold and start your Beacon</span></div>
              ...
              <div className="terminal-line">&nbsp;</div>
              <div className="terminal-line"><span className="comment"># Publish your first listing</span></div>
          ...
          <div className="callout" style={{ marginTop: 32 }}>
            <p><strong>Want the full API reference?</strong> The <a href="https://docs.pelagora.org" target="_blank" rel="noreferrer">Pelagora docs</a> cover every endpoint, schema, and extension point. Or drop the Skill into your project and let your AI agent figure it out.</p>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="ideas-grid">
            <div className="idea-card">
              ...
              <h3>Subscription &amp; Access Control</h3>
              <p>Gate content, services, or physical goods behind recurring offers managed entirely by your Beacon. No payment processor required — access logic lives in your Skill.</p>
            </div>
            <div className="idea-card">
